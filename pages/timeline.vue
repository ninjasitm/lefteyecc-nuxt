...
const state: State = reactive({
    ...
    timeline: computed(() => {
        ...
        return Object.values(timeline.map((item: any) => {
    ...
    <template v-else>
        <div class="constrained container mx-auto mt-6">
            <div class="grid grid-cols-1 sm:grid-cols">
                <div
                    class="mt-6 my-auto items-end justify-start"
                    style="z-index: 2"
                >
            ...
            <div class="mb-6 mt-12">
                <pretty-timeline :timeline-data="state.timeline" :base-color="theme.colors.primary" />
